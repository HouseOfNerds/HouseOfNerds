...
class CustomersControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create customer' do
    assert_difference('Customer.count') do
      post customers_url, params: { customer: { address: @customer.address, birthdate: @customer.birthdate, email: @customer.email, name: @customer.name, password_digest: @customer.password_digest, phone: @customer.phone, postal_code: @customer.postal_code } }
    end
